...
## 3.3 parametrização do modelo: paisagem hipotética, k e U
...
# 4. Estimativa da extensão espacial adequada
...
# 5. Estimativa da métrica funcional de conectividade
## 5.1 procedimento para obter logU/U
...
# 6. Congruência entre a SAD simulada e a SAD observada
## 6.1 procedimento para obter logOR
...
## 7.1 Dados Empíricos: inventários florestais e mapa de cobertura florestal contemporâneo
...
## 7.2 Efeito escalar da dispersão no mecanismo simulado
...
## 7.3 Efeitos explicativos da paisagem na predição da biodiversidade local

### 7.3.1 Análise exploratória da métrica de conectividade funcional
...
### 7.3.2 Congruência da SAD simulada com a SAD observada

#### 7.3.2.1 Descrição da congruência absoluta das paisagens hipotéticas
...
#### 7.3.2.2 Descrição dos efeitos explicativos da paisagem na biodiversidade local
