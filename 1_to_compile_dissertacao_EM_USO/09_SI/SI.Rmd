...
md_extra <- 
  readRDS("dados/csv_SoE/rds/l_md_semT2sitio_fragtotal.rds")
l_md[[names(md_extra)]] <- md_extra[[1]]
#
...
md_extra <- 
  readRDS("dados/csv_SoE/rds/l_md_semT2sitio_fragperse.rds")
l_md[[names(md_extra)]] <- md_extra[[1]]
#
...
md_extra <- 
  readRDS("dados/csv_SoE/rds/l_md_semT2sitio_areaperse.rds")
l_md[[names(md_extra)]] <- md_extra[[1]]
#
