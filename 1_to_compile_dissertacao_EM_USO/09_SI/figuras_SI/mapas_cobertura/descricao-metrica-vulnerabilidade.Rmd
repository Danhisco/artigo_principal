...
tab_models <- tibble::tibble(
  ...
  `Ecological interpretation` = c(
    "The vulnerability related to the landscape effect is shaped by the interaction of dispersal and the remaining forest cover (%FC)",
    ...
    "Once the baseline variations per plot are considered, the vulnerability is shaped by a common dispersal non-linear responses.",
    "Vulnerability is unrelated to dispersal, reflecting only local plot variations."
  )
)
