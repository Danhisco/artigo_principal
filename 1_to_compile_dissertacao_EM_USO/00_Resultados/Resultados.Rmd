...
knitr::include_graphics("./0_apendices/EfeitoEscala/figuras/figSI_S_N_sizeDA_fillSN.png")
```
...
knitr::include_graphics(path = "./0_apendices/EfeitoEscala/figuras/fig5_SoE.png")
```
