...
## Práticas ontológicas de programas de pesquisa em disputa em um sistema epistêmico contrafactual baseado em indivíduos
...
Assim, a conclusão da prática ontológica é a de quantificar o efeito da métrica da paisagem na descrição da biodiversidade local. Nós quantificamos o efeito da métrica da paisagem na congruência relativa do contraste entre contrafactuais. A congruência relativa é obtida em duas partes. Primeiro, a SAD simulada é comparada com a SAD observada pelo teste de Kolmogorov-Smirnov bootstrap e é contabilizado o número de SADs simuladas com boa congruência com a SAD observada. Segundo, 
é calculado o log da chance de uma SAD simulada ter boa congruência para cada contrafactual e então é calculado o log da razão da chance do contraste de contrafactuais. O log da razão da chance é usada como variável resposta de uma análise de regressão que tem a métrica funcional da paisagem como efeito fixo e aleatório, com cada paisagem livre para ter um particular efeito, e com as coordenadas espaciais do inventário e o ano do inventários como covariáveis fixas.
...
- Figura
1a parte) 3 quadros cada uma agregada por tipo de paisagem e com todos os sítios com traço mais claro e a média geral em destaque
2a parte) Efeitos da Paisagem: contraste entre as esimativas das taxas Us entre tipos de paisagens
