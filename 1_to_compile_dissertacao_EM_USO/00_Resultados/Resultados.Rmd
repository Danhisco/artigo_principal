...
### Métrica funcional da influência da paisagem ao redor na biodiversidade local
...
INCLUIR RESULTADOS DA MÉTRICA INCLUIR RESULTADOS DA MÉTRICA INCLUIR RESULTADOS DA MÉTRICA 
INCLUIR RESULTADOS DA MÉTRICA INCLUIR RESULTADOS DA MÉTRICA INCLUIR RESULTADOS DA MÉTRICA
...
a) Qual a melhor forma de expressar o efeito da paisagem por sítio? 
b) Os efeitos da paisagem apresentam grande influência nos dados observados?
c) O efeito médio da paisagem, dado os efeitos médios da paisagem por sítio de amostragem, apresentam alguma influência na congruência da SAD simulada com a SAD observada? Existe alguma tendência geral? O quanto é possível  
d) Qual a melhor forma de estimar o efeito causal médio da paisagem a partir dos possíveis conjuntos de covariáveis de ajuste, dado a estrutura hierarquica do modelo de regressão?
