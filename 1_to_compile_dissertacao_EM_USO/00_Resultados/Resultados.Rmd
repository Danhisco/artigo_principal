...
A análise dos dados a partir de modelo hierarquicos foi feita em etapas. Primeiro 




O contexto biogeográfico deve influenciar a biodiversidade local, determinando parte do padrão de abundância relativa (REF). 

Assim, o contexto biogeográfico é um pontencial confundidor (REF). 


, com cada paisagem livre para ter um particular efeito, e com as coordenadas espaciais do inventário e o ano do inventários como possíveis covariáveis fixas (seção 'Congruência relativa').
