...
```{r desloc-parcela, fig.height=2.5,fig.width=4.5}
...
```{r paisagens-hipoteticas, fig.cap="As 3 paisagem hipotéticas em paisagens com lado de 4 km: paisagem fragmentada = contemporâneo; paisagem aglomerada = sem isolamento estrutural; paisagem prístina = idealizado"}
...
### MAGH usados  {.unnumbered} {#formulas-md-CONG}
...
## Descrição estatística de logUi/Uj de cada efeito da paisagem  {.unnumbered}
