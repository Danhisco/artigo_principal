...
Contrafactual gráfico: Como seria Pr(Cong) caso log(N) e log(S) permanecem em seus valores médios e a variação entre sítios fossem desconsiderada? Ou seja, quais os efeitos de p e k apenas?

```{r função para predicao posteriori GAMM MNEE}
f_PredInt.GAMM <- \(data, gamm, 
                    quantiles = c(0.05,0.25,0.5,0.75,0.95),nsim=10000){
  data$predito <- predict(gamm, type = "response",
