...
Os contrastes de U (area e frag.) apresentam elevada assimetria, são pequenos em k elevado e podem ser elevados em k pequenos.
Entendo que é adequado simular o conjunto de dados para predição que explore combinações representativas da relação entre preditoras (k, area e frag.).
Busco descrever como o intervalo quantílico varia com
...
md_prcong <- l_md[[df_tab[1,"modelo"]]]
l_df <- list()
l_df[[1]] <- f_calcPI(gamm=md_prcong,ad = "ad4",newdata_path="./dados/csv/df_newdata_ad4.csv")
...
#   write_csv(l_df[[1]],file="./dados/csv/df_ip_prcong_kz_landhyp.csv")
# }
