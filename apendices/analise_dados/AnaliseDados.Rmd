...
ggsave("apendices/analise_dados/figuras/nCong_k_land.hyp_site.png",
       width = 7,height = 30)
save(p,file="./dados/Rdata/nCong_k_land.hyp_site.Rdata")
```
...
```{r}
l_f <- list()
l_[[1]] <- "~ p_z * forest_succession * k_f * land_hyp "
```
