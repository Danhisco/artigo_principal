...
f_plot_PrCong <- \(level_land.hyp){
  ...
  df_obs |> 
    ...
    labs(y="logito(Cong)",
         title=case_when(level_land.hyp == "cont" ~ "Paisagem Contemporânea",
                         level_land.hyp == "non_frag" ~ "Paisagem Aglomerada",
                         level_land.hyp == "ideal" ~ "Paisagem Idealizada"),
