...
```{r dag estudo de melhor caracterizacao de PrCong em funcao de SADobs e SADneutra,echo=F,include=F}
...
O spline de p e o tensor de p e k apresentam baixos valores de alpha (>25%) com os splines e tensores de N e S. Esse modelo é dos mais plausíveis o que faz melhor estimativa dos efeitos parciais em função de p e k, apesar do modelo acumular menos de 1% do peso de evidência.
...
Como seria Pr(Cong) caso log(N) e log(S) permanecem em seus valores médios e a variação entre sítios fossem desconsiderada? Ou seja, quais os efeitos de p e k apenas?
