...
f_gam_logOR <- function(df){
  ...
  l_md[[1]] <- gam(logOR ~ 
                     te(p_z,k_z) +
                     t2(p_z,k_z,SiteCode,bs=c("cr","cr","re"),full=TRUE),
                   data=df, method="REML")
  l_md[[2]] <- gam(logOR ~ 
                     te(cubeR_efeito_area_z,cubeR_efeito_frag_z) +
                     t2(cubeR_efeito_area_z,cubeR_efeito_frag_z,SiteCode,bs=c("cr","cr","re"),full=TRUE),
                   data=df, method="REML")
