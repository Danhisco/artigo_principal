...
# gráficos
v_names <- set_names(names(df_Ulogit)[16:19])
...
# modelos
l_md <- list()
l_md[[1]] <- lmer(Ulogit ~ S.z + Areas.z + DA.z + (1|SiteCode), data=df_Ulogit)
l_md[[2]] <- update(l_md[[1]], . ~ . -Areas.z)
l_md[[3]] <- update(l_md[[1]], . ~ . -DA.z)
l_md[[4]] <- update(l_md[[2]], . ~ . -DA.z)
