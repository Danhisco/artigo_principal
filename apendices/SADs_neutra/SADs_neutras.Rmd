...
f_plot.SADacumulada <- function(df,parallel=TRUE){
  # dados
  ...
  p <- ggplot(df_return,aes(x=Freq)) +
    ...
    theme_minimal()
  print(p)
  ggsave(filename = paste0("dados/csv/resultados_MN/MNEE/png_SADsAcumuladas/",df$SiteCode[1],".png"),
         plot = p, width = 11.04, height = 5.864)
}
