...
__tabela 1__ Tabela usada na análise de escala de efeito, primeiros 6 valores.  

```{r df se head, echo=FALSE}
df_se <- read_csv("./dados/csv/df_EscalaEfeito.csv")
df_se |> arrange(lado_km) |> head()
```
...
__Figura 3__ Gráficos Exploratórios das preditoras do modelo mais plausível, quando %CV(p) é calculado usando o maior lado da paisagem.
...
```{r dharma residuals modelo com maior peso de evidência}
