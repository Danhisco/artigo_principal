...
df_Usoe |> 
  ...
  labs(x="mudança acumulada de escala (lado da paisagem em km)",
       y="cumsum(Ulag)",
       title="Os graus de limitação de dispersão apropriados são mais severos ou iguais à k=0.40 na extensão de 4x4 km2 em média") +
  theme_classic()
```
