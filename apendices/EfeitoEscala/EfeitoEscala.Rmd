...
```{r figura 6 filtro de figura 3 apenas aqueles com low10}
df_plot <- df_Usoe |> filter(Ucv_factor=="low10") |> select(SiteCode, k) |> distinct() |> 
...
df_plot |>
  ...
  scale_x_continuous(trans='log2',breaks = round(16.02/2^(5:0),0)) +
  scale_color_distiller(palette = "Spectral") +
  labs(title = "Casos em que Ucv < 10",
