...
<p> __Figura 3__ U estimado (eixo y) nas diferentes extensões espaciais (eixo x) e para 3 cenários de limitação de dispersão (cor dos pontos e linhas, k = 0.05, 0.10 e 0.25). Pontos representam a média de 4 réplicas por bateria de simulação.</p>



```{r}
# df <- df_Usoe |> filter(SiteCode == "MGipia1")
f_lag.U <- function(df){
