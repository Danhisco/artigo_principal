...
df_plot |> 
  ...
  labs(x="k = proporção de propágulos que permanece na vizinhança imediaa",
       y="lado da paisagem (km)",
       title="lado da paisagem que acumula 99% de toda variação observada") +
  theme_classic()
```
