...
O efeito de escala varia de forma não linear com o grau de limitação de dispersão (Figura 4). 
Em graus brandos de limitação de dispersão o efeito de escala pode ser elevado (Figura 4 e 5), enquanto para graus pouco severos de limitação de dispersão o efeito da escala pode ser muito pequeno (Figura 4 e 5), principalmente em graus de limitação de dispersão pouco severos, onde há o aumento brusco da taxa U estimada (figura 3, 4 e 5). 
Calculamos a diferença entre a média de U de escalas consecutivas e dividimos pela amplitude de U para todas as escalas. Eperavamos que o aumento da escala iria reduzir a estimativa da taxa U, ou seja, os valores extremos de escala seriam os valores extremos de U e dessa forma é possível quantificar o efeito acumulado até uma determinada escala (Figura 6). Isso foi observado em graus de limitação de dispersão severos e brandos, nos graus pouco severos  onde a estimativa de U é elevada (figura 2) esse padrão pode não ocorrer, e em alguns casos o aumento da escala pode elevar o

Em alguns graus de limitação de dispersão há pouca variação entre escalas (Figura 5). Nos graus de limitação de dispersão mais brandos há a maior variação e depois os cenários de limitação à dispersão mais severos; aqueles graus de limitação de dispersão onde há o aumento brusco da estimativa de U há baixa variação entre escalas (Figura 4 e 5).
