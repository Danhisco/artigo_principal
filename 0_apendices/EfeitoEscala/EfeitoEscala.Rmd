...
```{r figura 1 variaveis de controle e cenarios de limitacao de dispersao,fig.height=3.5,fig.width=10,eval=FALSE,include=FALSE}
if(FALSE){
  df_p <- df_sim |>
    filter(k==0.05) |> 
...
```
```{r comparacao-limiares,fig.cap=vcap}
