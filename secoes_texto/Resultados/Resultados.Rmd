...
df_contrastes <- read_csv(file="dados/csv/taxaU/df_contrastes.csv") %>% select(-p)
...
#
v_cols <- select(df_contrastes,matches("dif|ratio")) %>% names()
