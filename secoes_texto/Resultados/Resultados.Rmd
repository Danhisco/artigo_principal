...
## df_plotSoE
df_plotSoE <- read_csv("dados/csv/df_plotSoE.csv") |> 
...
```{r figura 2 p em funcao das extensoes espaciais}
...
__Figura 2__ Variação da proporção de cobertura vegetal contemporânea ao evento de amostragem do inventário florestal e a extensão espacial da paisagem ao redor. 
...
v_threshold <- paste0("SoE >= ",
                      str_extract(paste(names(df_plotSoE),collapse = " "),
                                  "(?<=SoE\\_)[0-9]{1}[.][0-9]{1,2}")) 
