...
Há muita diversidade de padrões entre sítios de amostragem  (fig. \@ref(fig:GE-nCong)). Em alguns há pouca variação na congruência da SAD simulada e predita, nesses casos, em geral  com boa congruência para todos os graus de limitação de dispersão e tipos de paisagens (fig. \@ref(fig:GE-nCong)). Em outros há variação na congruência com a variação no grau de limitação de dispersão, nesses casos pode existir variabilidade entre tipos de paisagens hipotéticas, em que o tipo de paisagem hipotética com melhor congruência pode variar entre sítios (fig. \@ref(fig:GE-nCong)). Ao ordenar os gráficos dos sítios por porcentagem de cobertura vegetal na paisagem de 4x4km (p) é possível observar que os sítios com pouca perda de habitat não apresentam diferença entre os tipos de paisagens hipotéticas (fig. \@ref(fig:GE-nCong)). A partir de um valor de p é possível observar diferença entre tipos de paisagens (fig. \@ref(fig:GE-nCong)). O simulado nas paisagens idealizadas e sem isolamento estrutural em geral apresentam diferença menor e o simulado na paisagem contemporânea pode apresentam maior diferença em alguns graus de limitação de dispersão (fig. \@ref(fig:GE-nCong)). 
