...
__Figura 2__ Taxa U estimada em cada sítio nos 20 graus de limitação de dispersão simulados e coloridos pelo tipo de paisagem hipotética. Os sítios estão organizados pela proporção de cobertura vegetal na paisagem de 4x4 km2.
...
```{r}
df_ts_re <- read_csv("./dados/csv/df_ts_re_nCong.csv")
