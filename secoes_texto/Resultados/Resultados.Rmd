...
l_df[[2]] <- data.frame(contraste = c("área per se","fragmentação per se","contemporaneidade"),
                 ...
                 `interpretação` = c("efeito de perda de habitat:
                                 ...
                                 diferença entre a conectividade 
                                 na paisagem observada no mesmo momento da amostragem e 
...
v_footnote <- c(NA,NA,"variável que controla a influência da paisagem ao redor na dinâmica local,
...
```{r frag ~ area Taxa U, fig.cap="\\label{frag_area_taxaU}frag ~ area Taxa U"}
