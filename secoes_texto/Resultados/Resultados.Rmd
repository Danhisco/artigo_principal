...
l_df[[2]] <- data.frame(contraste = c("área per se","fragmentação per se","contemporaneidade"),
                 ...
                 `descrição` = c("efeito de perda de habitat:
                                 Componente da conectividade contemporânea que depende apenas da quantidade do habitat remanescente",
                                 "efeito de fragmentação per se:
                                 Componente da conectividade contemporânea que depende apenas da configuração espacial do habitat remanescente",
                                 "efeito da conectividade contemporânea:
                                 diferença entre a conectividade na paisagem observada no mesmo momento da amostragem e na paisagem sem perda de habitat")
                 )
names(l_df) <- c("predições","contrastes")
v_title <- c("tipos de predições","tipos de contrastes")
l_df <- l_df %>% 
  f_gt(.,v_title) %>% 
  f_gt_to_ggplot()
