...
```{r graus de limitação de dispersão simulados, eval=F,include=F}
df_sim |> 
...
[a]como o efeito de escalar foi avaliado apenas com a taxa U acredito que preciso incluir uma descrição da variabilidade entre réplicas (e.g. %coeficiente de variação)
